...
sqlite3 $DATABASE_PATH "INSERT INTO internet_sessions VALUES (${TABLE_INDEX},${USER_ID},'${SESSION_ID}',${LANE_ID},'${USER_IP}',${SESSION_TX},${SESSION_RX},${SESSION_ACCESS},'${DATETIME}','${DATETIME_LASTREQUEST}')"
echo $?
echo "sqlite3 $DATABASE_PATH \"INSERT INTO internet_sessions VALUES (${TABLE_INDEX},${USER_ID},'${SESSION_ID}',${LANE_ID},'${USER_IP}',${SESSION_TX},${SESSION_RX},${SESSION_ACCESS},'${DATETIME}','${DATETIME_LASTREQUEST}')\""
exit
